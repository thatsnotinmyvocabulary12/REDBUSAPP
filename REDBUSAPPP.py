...
if web == "Home":
    ...
    slt.markdown("The 'Redbus Data Scraping and Filtering with Streamlit Application' aims...")
...
if web == "🌐 States and Routes ":
    ...
    with col2:
        fare_range = slt.radio("Choose bus fare range", ("50-700", "700-1000","1000 above"))
